...
const INITIAL_GOALS = [
  { id: 1, category: "biznes", priority: "high", text: "Potwierdzić makijażystę i stylistę na pokaz w Paryżu (7 lipca)", status: "todo", progress: 0,
    steps: [{ id: "1a", text: "Sprawdzić kontakt do makijażysty z poprzedniego pokazu", done: false }, { id: "1b", text: "Wysłać wiadomość z datą i szczegółami pokazu", done: false }, { id: "1c", text: "Potwierdzić dostępność i stawkę", done: false }, { id: "1d", text: "Podpisać umowę lub potwierdzenie mailowe", done: false }],
    aiContext: "Potwierdzam ekipę beauty na pokaz mody w Paryżu 7 lipca. Potrzebuję makijażysty i stylisty." },
  { id: 2, category: "biznes", priority: "high", text: "Zmontować odcinek YouTube + zapowiedzi Shorts (publikacja środa 19:00)", status: "todo", progress: 0,
    steps: [{ id: "2a", text: "Zebrać materiał wideo z tego tygodnia", done: false }, { id: "2b", text: "Zmontować główny odcinek (do wtorku)", done: false }, { id: "2c", text: "Wyciąć 3 Shorts z najlepszych momentów", done: false }, { id: "2d", text: "Napisać opis i tagi", done: false }, { id: "2e", text: "Zaplanować publikację na środę 19:00", done: false }],
    aiContext: "Prowadzę kanał YouTube o modzie i biznesie. Publikuję w środy o 19:00." },
  { id: 3, category: "biznes", priority: "high", text: "Potwierdzić cenę publikacji 3 zdjęć na portalu Fashion Biznes", status: "todo", progress: 0,
    steps: [{ id: "3a", text: "Sprawdzić cennik Fashion Biznes", done: false }, { id: "3b", text: "Skontaktować się z redakcją", done: false }, { id: "3c", text: "Wynegocjować cenę i warunki", done: false }, { id: "3d", text: "Przesłać zdjęcia i potwierdzić termin publikacji", done: false }],
    aiContext: "Negocjuję cenę publikacji 3 zdjęć na portalu Fashion Biznes. Jestem modelką i businesswoman." },
  { id: 4, category: "biznes", priority: "high", text: "Umówić współpracę z portalem Kozaczek", status: "todo", progress: 0,
    steps: [{ id: "4a", text: "Znaleźć kontakt do działu współpracy Kozaczek", done: false }, { id: "4b", text: "Przygotować krótką propozycję współpracy", done: false }, { id: "4c", text: "Wysłać wiadomość i umówić call", done: false }, { id: "4d", text: "Ustalić warunki i podpisać umowę", done: false }],
    aiContext: "Szukam współpracy z portalem Kozaczek jako twórca treści z branży fashion i lifestyle." },
  { id: 5, category: "biznes", priority: "critical", text: "Wynegocjować ryczałtową stawkę wynagrodzenia dla mecenasa", status: "inprogress", progress: 30,
    steps: [{ id: "5a", text: "Sprawdzić aktualne koszty obsługi prawnej", done: true }, { id: "5b", text: "Określić budżet który chcę osiągnąć", done: true }, { id: "5c", text: "Wysłać propozycję ryczałtu do mecenasa", done: false }, { id: "5d", text: "Przeprowadzić negocjację", done: false }, { id: "5e", text: "Podpisać aneks do umowy z nową stawką", done: false }],
    aiContext: "Negocjuję ryczałtową stawkę z moim prawnikiem. Chcę zastąpić rozliczenie godzinowe stałą miesięczną opłatą." },
  { id: 12, category: "biznes", priority: "high", text: "Wysłać butelkę szampana do mecenasa", status: "todo", progress: 0,
    steps: [{ id: "12a", text: "Wybrać dostawcę z dostawą do kancelarii", done: false }, { id: "12b", text: "Zamówić z dedykacją", done: false }],
    aiContext: "Chcę wysłać szampana jako gest dobrej woli po negocjacjach z moim prawnikiem." },
  { id: 6, category: "biznes", priority: "medium", text: "Usunąć artykuły na portalu Onet", status: "todo", progress: 0,
    steps: [{ id: "6a", text: "Znaleźć artykuły do usunięcia na Onet", done: false }, { id: "6b", text: "Skontaktować się z redakcją Onet", done: false }, { id: "6c", text: "Złożyć wniosek o usunięcie treści (RODO)", done: false }, { id: "6d", text: "Potwierdzić usunięcie", done: false }],
    aiContext: "Chcę usunąć artykuły o mnie z portalu Onet. Mogę powołać się na prawo do bycia zapomnianym (RODO)." },
  { id: 7, category: "dom", priority: "high", text: "Oczyścić dom ze starych rzeczy i przygotować do najmu", status: "todo", progress: 0,
    steps: [{ id: "7a", text: "Zrobić listę rzeczy do wyrzucenia / oddania", done: false }, { id: "7b", text: "Wywieźć lub oddać niepotrzebne rzeczy", done: false }, { id: "7c", text: "Zorganizować sprzątanie generalne", done: false }, { id: "7d", text: "Zrobić zdjęcia do ogłoszenia", done: false }, { id: "7e", text: "Wystawić ogłoszenie o najmu", done: false }],
    aiContext: "Przygotowuję dom do wynajmu. Potrzebuję go opróżnić i przygotować na najemców." },
  { id: 11, category: "dom", priority: "critical", text: "Naprawa ogrodu i płotu przed najmem", status: "inprogress", progress: 40,
    steps: [{ id: "11a", text: "Skontaktować się z ekipą remontową", done: true }, { id: "11b", text: "Spotkanie z Michałem Narkiewiczem (wt 30.06 20:00)", done: false }, { id: "11c", text: "Otrzymać wycenę naprawy", done: false }, { id: "11d", text: "Zaakceptować i podpisać zlecenie", done: false }, { id: "11e", text: "Nadzorować realizację prac", done: false }],
    aiContext: "Naprawiam ogród i płot przed wynajmem domu. Mam już umówione spotkanie z wykonawcą." },
  { id: 8, category: "dom", priority: "medium", text: "Budowa Ursus — dopilnowanie montażu mebli (środa 13:00–17:00)", status: "todo", progress: 0,
    steps: [{ id: "8a", text: "Potwierdzić godzinę z ekipą montażową", done: false }, { id: "8b", text: "Pojechać na budowę w środę o 13:00", done: false }, { id: "8c", text: "Sprawdzić jakość montażu i zaakceptować", done: false }],
    aiContext: "Nadzoruję montaż mebli w mieszkaniu mamy w Ursusie. Muszę być na miejscu w środę 13-17." },
  { id: 9, category: "dom", priority: "low", text: "Umówić przegląd auta", status: "todo", progress: 0,
    steps: [{ id: "9a", text: "Zadzwonić do serwisu", done: false }, { id: "9b", text: "Umówić termin", done: false }],
    aiContext: "Potrzebuję umówić przegląd techniczny samochodu." },
  { id: 10, category: "życie", priority: "medium", text: "Wyjść do teatru (środa wieczór)", status: "todo", progress: 0,
    steps: [{ id: "10a", text: "Wybrać spektakl w Warszawie", done: false }, { id: "10b", text: "Kupić bilety online", done: false }],
    aiContext: "Chcę wybrać się do teatru w środę wieczór w Warszawie." },
];
...
export default function App() {
  ...
  useEffect(() => {
    if (!loaded) return;
    localStorage.setItem("goals-v3", JSON.stringify(goals));
  }, [goals, loaded]);
  ...
  const askAI = async (goal, mode) => {
    ...
    const prompts = {
      ...
      strategy: `Jestem Gosia Leitner — polska businesswoman i modelka. Zadanie: "${goal.text}". Postęp: ${goal.progress}%. Kontekst: ${goal.aiContext}. Daj strategię w 3-4 punktach jak domknąć to w tym tygodniu. Uwzględnij możliwe przeszkody. Po polsku.`,
    };
    try {
        ...
        <div style={s.cardTop} onClick={() => setExpandedId(isExpanded ? null : goal.id)}>
          <div style={s.cardBody}>
            <div style={s.cardPriority}>
              ...
              <span style={{ ...s.statusPill, background: STATUS_META[goal.status].bg, color: STATUS_META[goal.status].color }}>
                {STATUS_META[goal.status].label}
              </span>
              <span style={s.stepsBadge}>{stepsDone}/{stepsTotal} kroków</span>
            </div>
              ...
              <div style={s.aiModes}>
                {AI_MODES.map(m => (
                  <button key={m.id} onClick={() => setAiMode(m.id)}
                    style={{ ...s.aiModeBtn, ...(aiMode === m.id ? s.aiModeBtnActive : {}) }}>
                    {m.label}
                  </button>
                ))}
              </div>
          ...
          <div>
            <div style={s.statsRow}>
              <div style={s.statCard}>
                ...
                <div style={s.statLabel}>Ukończone</div>
                <div style={s.miniBar}><div style={{ ...s.miniBarFill, width: `${donePct}%`, background: "#C8A97E" }} /></div>
              </div>
              <div style={s.statCard}>
                <div style={{ ...s.statNum, color: "#C8A97E" }}>{inProgressCount}</div>
                <div style={s.statLabel}>W toku</div>
                <div style={s.miniBar}><div style={{ ...s.miniBarFill, width: `${(inProgressCount / goals.length) * 100}%`, background: "#C8A97E" }} /></div>
              </div>
              <div style={s.statCard}>
              ...
              return (
                <div key={cat} style={s.summaryRow}>
                  <div style={s.summaryRowTop}>
                    ...
                    <span style={s.summaryPct}>{avg}%</span>
                  </div>
